...
public class Booking extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(689, 390));
        setPreferredSize(new java.awt.Dimension(689, 390));
        getContentPane().setLayout(null);

        mainPanel.setMinimumSize(new java.awt.Dimension(689, 380));
        mainPanel.setOpaque(false);
        mainPanel.setPreferredSize(new java.awt.Dimension(689, 380));

        headerLabel.setFont(new java.awt.Font("Tempus Sans ITC", 1, 18)); // NOI18N
        headerLabel.setText("Book your tickets in 4 easy steps!");

        cardPanel.setMinimumSize(new java.awt.Dimension(566, 290));
        cardPanel.setName(""); // NOI18N
        cardPanel.setOpaque(false);
        cardPanel.setPreferredSize(new java.awt.Dimension(566, 290));
        ...
        mainPanel.setBounds(0, 0, 689, 380);

        BackgroundIMG.setIcon(new javax.swing.ImageIcon(getClass().getResource("/airlines/bookbg1.jpg"))); // NOI18N
        BackgroundIMG.setMaximumSize(new java.awt.Dimension(689, 380));
        BackgroundIMG.setMinimumSize(new java.awt.Dimension(689, 380));
        BackgroundIMG.setPreferredSize(new java.awt.Dimension(689, 380));
        getContentPane().add(BackgroundIMG);
        BackgroundIMG.setBounds(0, 0, 690, 380);
